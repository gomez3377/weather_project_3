...
const Sidebar = ({ weatherConditions }) => {
  ...
  return (
    <div className='bg-darkBlue w-1/3 h-fit-content text-mutedGray p-12 relative'>
      ...
      <header className='flex justify-between'>
        ...
        <button className='bg-gray text-nearWhite px-4 py-2.5 font-medium shadow-2'
        onClick={toggleSearchSidebar}>Search for Places</button>
